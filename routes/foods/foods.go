...
func Routes(app *fiber.App) {
	app.Get("api/foods/foods", utils.Secure(models.ROLES{models.ADMIN, models.OPERATOR, models.USER}), handlers.GetItems(models.Food{}))
	app.Get("api/foods/buffet-items", foods.GetBuffetItems)
	app.Post("api/foods/add-card", foods.AddCart)
	app.Get("api/foods/food", utils.Secure(models.ROLES{models.ADMIN, models.OPERATOR, models.USER}), handlers.GetItem(models.Food{}))
